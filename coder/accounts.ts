...
const AMM_INFO_LAYOUT: any = B.struct([
    ...
    B.struct([B.u64('minSeparateNumerator'), B.u64('minSeparateDenominator'), B.u64('tradeFeeNumerator'), B.u64('tradeFeeDenominator'), B.u64('pnlNumerator'), B.u64('pnlDenominator'), B.u64('swapFeeNumerator'), B.u64('swapFeeDenominator'),], 'fees'),
    B.struct([B.u64('needTakePnlCoin'), B.u64('needTakePnlPc'), B.u64('totalPnlPc'), B.u64('totalPnlCoin'), B.u64('poolOpenTime'), B.u64('punishPcAmount'), B.u64('punishCoinAmount'), B.u64('orderbookToInitTime'), B.u128('swapCoinInAmount'), B.u128('swapPcOutAmount'), B.u64('swapTakePcFee'), B.u128('swapPcInAmount'), B.u128('swapCoinOutAmount'), B.u64('swapTakeCoinFee'),], 'outPut'),
